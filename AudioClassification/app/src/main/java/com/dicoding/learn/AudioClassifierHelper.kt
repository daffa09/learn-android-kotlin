...
class AudioClassifierHelper(
    ...
    val context: Context,
    val classificationListener: ClassificationListener? = null
) {
    ...
    private fun initClassifier() {
        try {
            ...
            classificationListener?.onError(context.getString(R.string.audio_classifier_failed))
    ...
    private fun streamAudioResultListener(resultListener: AudioClassifierResult) {
        classificationListener?.onResults(
