...
class BertQAHelper(
    ...
    private fun setupBerQuestionAnswerer() {
        ...
        try {
            ...
            resultAnswerListener?.onErrror("Bert Question Answerer gagal untuk terinisialisasi")
    ...
    fun getQuestionAnswer(topicsContent: String, question: String) {
        if (bertQuestionAnswerer == null) {
            setupBerQuestionAnswerer()
        }

        var inferenceTime = System.currentTimeMillis()

        val answer = bertQuestionAnswerer?.answer(topicsContent, question)

        inferenceTime = System.currentTimeMillis() - inferenceTime

        resultAnswerListener?.onResult(answer, inferenceTime)
    }
