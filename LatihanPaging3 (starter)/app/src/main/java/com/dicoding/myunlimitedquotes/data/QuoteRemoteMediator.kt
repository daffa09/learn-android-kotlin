...
class QuoteRemoteMediator(
    ...
    private suspend fun getRemoteKeysForLastItem(state: PagingState<Int, QuoteResponseItem>) : RemoteKeys? {
    ...
    suspend fun getRemoteKeysClosestToCurrentPosition(state: PagingState<Int, QuoteResponseItem>) : RemoteKeys? {
