package com.dicoding.learn.adapter
...
import com.dicoding.learn.databinding.ItemNoteBinding
    ...
    inner class NoteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(note: Note) {
            ...
            binding.cvItemNote.setOnClickListener{
                onItemClickCallback.onItemClickClicked(note, adapterPosition)
            }
        }
    }
...
interface OnItemClickCallback {
    fun onItemClickClicked(selectedNote: Note?, position: Int?)
}
