...
class SeatsView: View {
    ...
    override fun onTouchEvent(event: MotionEvent?): Boolean {
        ...
        val heightRowFour = (halfOfHeight + 400F)..(halfOfHeight + 500F)
    ...
    private fun drawSeat(canvas: Canvas?, seat: Seat) {
        ...
        val armsrestPath = Path()
        armsrestPath.addRect(0F,0F,50F,200F, Path.Direction.CCW)
        canvas?.drawPath(armsrestPath,armrestPaint)
